...
const styles = {
  ...
  badge: {
    ...
    backgroundColor: "#e8f0fe", // Professional light blue for Demo status
    color: "#1a73e8",
  },
  emptyState: {
    textAlign: "center",
  ...
  return (
    <div style={styles.wrapper}>
      ...
      <div style={styles.header}>
        <h2 style={styles.title}>Demo Leads</h2>
        <span style={styles.count}>{leads.length} DEMOS</span>
      </div>
            ...
            {leads.length === 0 ? (
              <tr>
                <td colSpan="5" style={styles.td}>
                  <div style={styles.emptyState}>No demo leads found</div>
                </td>
              </tr>
            ) : (
              leads.map(l => (
