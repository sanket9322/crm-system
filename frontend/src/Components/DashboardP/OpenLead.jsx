...
const styles = {
  ...
  badge: {
    ...
    backgroundColor: "#e6f4ea", // Clean green tint for Open status
    color: "#137333",
  },
  emailBtn: {
  ...
  return (
    <div style={styles.wrapper}>
      ...
      <div style={styles.header}>
        <h2 style={styles.title}>Open Leads</h2>
        <span style={styles.count}>{leads.length} OPEN</span>
      </div>
      ...
      <div style={styles.tableContainer}>
        <table style={styles.table}>
          ...
          <tbody>
            {leads.length === 0 ? (
              <tr>
                {/* Fixed colSpan to 6 to balance the table grid structurally */}
                <td colSpan="6" style={styles.td}>
                  <div style={styles.emptyState}>No open leads found</div>
                </td>
              </tr>
            ) : (
              leads.map(l => (
